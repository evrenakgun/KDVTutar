...
public class KDVtutar {
	public static void main(String[] args) {
		...
		if (tutar > 1000) {
			System.out.println("KDV'li fiyat: " + (kdvTutar2 + tutar) + " TL'dir. KDV tutari ise " + kdvTutar2 + " TL'dir.");
		} 
		
		else if (tutar > 0 && tutar <= 1000) {
			System.out.println("KDV'li fiyat: " + (kdvTutar1 + tutar) + " TL'dir. KDV tutari ise " + kdvTutar1 + " TL'dir.");
		}
